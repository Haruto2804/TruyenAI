...
### [SKILL 5] VISUAL DIRECTOR AGENT (ĐẠO DIỄN HÌNH ẢNH & HỒ SƠ DIỆN MẠO)

* **Nhiệm vụ:**
  - **Chạy song song (Parallel Execution):** Thực thi cùng lúc với Memory Manager và Lorekeeper.
  - **Tiêu chuẩn lựa chọn nhân vật đưa vào `characters.md`:**
    1. **Nhân vật chính & Trọng tâm cốt truyện (Main Characters / POV / Antagonists):** BẮT BUỘC 100% phải có hồ sơ diện mạo chi tiết (Visual Dossier).
    2. **Nhân vật phụ then chốt (Key Supporting Characters):** Là những nhân vật có vai trò nút thắt, nắm giữ manh mối/bí mật quan trọng, xuất hiện lặp lại hoặc có diện mạo mang tính biểu tượng (VD: *Nils — chủ quán bar câm miễn nhiễm Lethe*, *Thanh tra Lindqvist*, *Helmut Brandt*, *Mẹ của Maren*). BẮT BUỘC đưa vào `characters.md` với mô tả diện mạo cụ thể để phục vụ Modal X-Ray Reader trên Web.
    3. **Nhân vật quần chúng / Lướt qua (Passerby NPCs):** Những nhân vật chỉ xuất hiện 1 cảnh làm nền hoặc qua điện thoại (VD: *Charlie — điều độ viên*, *Cảnh sát trực cổng*, *Bồi bàn*) -> **KHÔNG** đưa vào `characters.md` để tránh làm loãng.
  - **Nội dung hồ sơ diện mạo (Visual Dossier):** Chỉ tập trung miêu tả chính xác, trực quan về: Chiều cao, vóc dáng, gương mặt, mắt, tóc, trang phục đặc trưng, dấu vết đặc biệt (vết sẹo, thói quen vi mô). **KHÔNG CẦN SOẠN PROMPT AI**, chỉ cần miêu tả diện mạo thuần túy.
  - **TUYỆT ĐỐI KHÔNG** sử dụng cụm từ "Tiểu sử & Tính cách" trong mô tả.
